...
if __name__ == "__main__":
    ...
    parser.add_argument('-client',      '--client',         help = 'Client name')
    parser.add_argument('-project',     '--project',        help = 'Project name')
    parser.add_argument('-env',         '--env',            help = 'Environment name, like DEV, UAT, LAB1...')
    parser.add_argument('-repo',        '--repo',           help = 'Path to your project repo')
    parser.add_argument('-branch',      '--branch',         help = 'Repo branch')
    ...
    parser.add_argument('-hostname',    '--hostname',       help = 'Hostname')
    parser.add_argument('-port',        '--port',           help = 'Port',                        type = int, default = 1521)
    parser.add_argument('-service',     '--service',        help = 'Service name')
    parser.add_argument('-sid',         '--sid',            help = 'SID')
    parser.add_argument('-wallet',      '--wallet',         help = 'Wallet file')
    parser.add_argument('-wallet_pwd',  '--wallet_pwd',     help = 'Wallet password')
